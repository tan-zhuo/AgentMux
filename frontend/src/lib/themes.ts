...
export const themes: Theme[] = [
  {
    ...
    window: '#1c1c1e',
    colors: {
      // The ramp is Apple's dark system greys: black for the terminal plane,
      // systemBackground for the window, and the elevated greys above it.
      'ink-950': '#000000',
      'ink-900': '#1c1c1e',
      'ink-850': '#242426',
      'ink-800': '#2c2c2e',
...
export const defaultThemeId = 'macos-dark'
