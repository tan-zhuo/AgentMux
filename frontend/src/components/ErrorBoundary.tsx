  ...
  render() {
    ...
    return (
      <div className="flex h-full w-full flex-col bg-ink-900 p-6 text-ink-200">
        ...
        <pre className="mt-4 max-h-40 shrink-0 overflow-auto rounded-lg border border-danger/30 bg-danger/5 px-3 py-2 font-mono text-[11px] leading-relaxed whitespace-pre-wrap text-danger">
        ...
        <div className="mt-4 flex gap-2">
          <button
            ...
            className="rounded-md border border-accent-dim bg-accent/15 px-3 py-1.5 text-xs font-medium text-accent hover:bg-accent/25"
          >
