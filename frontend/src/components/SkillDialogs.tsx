      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="mb-1 flex items-center justify-between">
            <span className="text-[11px] font-medium tracking-wide text-ink-300 uppercase">
              Steps
            </span>
            <Button
              size="sm"
          ...
          <div className="space-y-2">
            {steps.map((s, i) => (
              <div key={i} className="rounded-md border border-ink-750 bg-ink-800 p-2">
  ...
  return (
    ...
    >
      <div className="space-y-2">
        ...
        {versions.map((v) => (
          <div key={v.id} className="rounded-md border border-ink-750 bg-ink-800 p-2.5">
